const generaNumeroCasuale = (): number => {
  ...
  const confrontaNumeri = () => {
    ...
    const risultatoDiv = document.getElementById('risultato') as HTMLDivElement;
  
    const numeroEstratto:number = generaNumeroCasuale();
  ...
  const avviaButton = document.getElementById('avviaButton') as HTMLButtonElement;
